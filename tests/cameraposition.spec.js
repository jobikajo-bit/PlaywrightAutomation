...
await page.locator('#img-select-menu-pointer-dropdown').click();
await page.locator('#div-select-menu-filter-selection').click();
await page.locator('div:nth-child(13) > .p-1 > .checkbox').click();
AllureUtils.takeScreenshot(page,'wall selected');
